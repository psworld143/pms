    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="relative">
            ...
            <div id="quick-actions-dropdown" class="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 hidden z-50">
                ...
                <div class="py-2">
                    <a href="<?php echo booking_url('modules/management/reports-dashboard.php'); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
        ...
        <div class="relative">
            ...
            <div id="user-dropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 hidden z-50">
                ...
                <div class="py-2">
                    ...
                    <a href="<?php echo booking_url('modules/management/settings.php'); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <i class="fas fa-cog mr-3"></i>
                        System Settings
                    </a>
                    <a href="<?php echo booking_url('modules/management/audit-log.php'); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
