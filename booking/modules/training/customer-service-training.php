        ...
        <main class="lg:ml-64 mt-16 p-4 lg:p-6 flex-1 transition-all duration-300">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <?php else: ?>
                    ...
                    <div class="text-center py-12">
                        ...
                        <a href="customer-service-results.php?attempt_id=<?php echo $attempt_id; ?>" 
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                        <strong>Situation:</strong> <?php echo htmlspecialchars($scenario["situation"]); ?>
                    </div>
                    <div>
                        <strong>Guest Request:</strong> <?php echo htmlspecialchars($scenario["guest_request"]); ?>
                    </div>
                </div>
            </div>
        </main>
