        ...
        <main class="lg:ml-64 mt-16 p-4 lg:p-6 flex-1 transition-all duration-300">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div class="text-right">
                        <div class="flex items-center space-x-4">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-purple-600"><?php echo $scenario['points']; ?></div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <p class="text-gray-700 leading-relaxed"><?php echo nl2br(htmlspecialchars($scenario['instructions'])); ?></p>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <?php if ($in_progress_attempt): ?>
                            <a href="scenario-training.php?id=<?php echo $scenario_id; ?>&attempt_id=<?php echo $in_progress_attempt['id']; ?>" 
                               class="w-full bg-yellow-600 text-white px-4 py-2 rounded-md hover:bg-yellow-700 transition-colors text-center block">
                                <i class="fas fa-play mr-2"></i>
                                Continue Training
                            </a>
                        <?php else: ?>
                            <a href="scenario-training.php?id=<?php echo $scenario_id; ?>" 
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <?php if ($attempt['status'] === 'in_progress'): ?>
                                        <a href="scenario-training.php?id=<?php echo $scenario_id; ?>&attempt_id=<?php echo $attempt['id']; ?>" 
