...
// Error handling for production
ini_set('display_errors', 0);
ini_set('log_errors', 1); echo ($current_question - 1) / count($questions) * 100; ?>%"></div>
                </div>
            </div>
...
// Error handling for production
ini_set('display_errors', 0);
ini_set('log_errors', 1); if (!empty($question['options_array'])): ?>
                            <?php
// Error handling for production
ini_set('display_errors', 0);
...
ini_set('log_errors', 1); else: ?>
                    ...
                    <div class="text-center py-12">
                        ...
                        <a href="scenario-results.php?attempt_id=<?php
// Error handling for production
ini_set('display_errors', 0);
ini_set('log_errors', 1); echo $attempt_id; ?>" 
...
ini_set('log_errors', 1); echo htmlspecialchars($scenario['description']); ?>
                    ...
                    <div>
                        <strong>Instructions:</strong> <?php
// Error handling for production
ini_set('display_errors', 0);
ini_set('log_errors', 1); echo htmlspecialchars($scenario['instructions']); ?>
                    </div>
                </div>
            </div>
        </main>
