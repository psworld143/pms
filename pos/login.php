    ...
    <style>
        * {
        ...
        .form-input:focus {
            ...
            border-color: #11998e;
            background: white;
            box-shadow: 0 0 0 5px rgba(17, 153, 142, 0.1);
        }
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="logo-section">
                ...
                <h1 class="system-title">Point of Sale (POS)</h1>
                <p class="system-subtitle">Restaurant, Spa, Gift Shop & Room Service</p>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">
                    <i class="fas fa-key" style="color: #11998e;"></i>
                    Demo Credentials
                </h3>
            ...
            <div class="credential-item">
                ...
                <div class="credential-value">student1 / password123</div>
            </div>

            <div class="credential-item">
                <div class="credential-role"><i class="fas fa-user-check"></i> Demo User</div>
                <div class="credential-value">demo_user / demo123</div>
            </div>

            <div class="alert alert-success" style="margin-top: 20px; margin-bottom: 0;">
                <i class="fas fa-info-circle" style="font-size: 1.3rem;"></i>
                <span><strong>Note:</strong> System supports both staff and student access</span>
            </div>
        </div>
    </div>
