...
$page_title = 'Room Service Orders';
...
<body class="bg-gray-50">
    <div class="flex min-h-screen">
        ...
        <main class="main-content pt-20 px-4 pb-4 lg:px-6 lg:pb-6 flex-1 transition-all duration-300">
                <!-- Page Header -->
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">Room Service Orders</h1>
                    <p class="text-gray-600">Manage room service orders and delivery status</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="bg-white rounded-lg shadow p-4 border-l-4 border-warning">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-gray-900">Preparing</h3>
                    ...
                    <div class="bg-white rounded-lg shadow p-4 border-l-4 border-info">
                        <div class="flex items-center">
                            <div class="p-2 bg-info bg-opacity-10 rounded-lg">
                                <i class="fas fa-truck text-info text-lg"></i>
                            </div>
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-gray-900">Out for Delivery</h3>
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="p-4 border-b border-gray-200 flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-gray-800">Active Room Service Orders</h3>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#RS001</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">12 min ago</td>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#RS002</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button class="text-blue-600 hover:text-blue-900 mr-3">View</button>
                                        <button class="text-green-600 hover:text-green-900">Delivered</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#RS003</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">3 min ago</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button class="text-blue-600 hover:text-blue-900 mr-3">View</button>
    ...
    <script>
        ...
        function viewOrder(orderId) {
            console.log('Viewing room service order:', orderId);
        }
        ...
        function cancelOrder(orderId) {
            console.log('Cancelling room service order:', orderId);
        }
    </script>
