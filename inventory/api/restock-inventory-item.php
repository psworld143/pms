...
try {
    ...
    $result = restockInventoryItem($item_id, $quantity, $unit_price, $reason);
    ...
    error_log("Error restocking inventory item: " . $e->getMessage());
    echo json_encode([
        'success' => false,
 ...
 * Restock inventory item
 */
function restockInventoryItem($item_id, $quantity, $unit_price, $reason) {
    global $pdo;
