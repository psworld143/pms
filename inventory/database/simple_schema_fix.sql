-- Simple Schema Fix for Inventory Management System
-- Hotel PMS Training System - Inventory Module
-- This script safely fixes column name mismatches
...
-- Step 2: Check what columns exist and populate accordingly
-- This will work regardless of whether the table has 'name' or 'item_name' column

-- If the table has both 'name' and 'item_name', copy from 'name' to 'item_name'
...
-- If the table has both 'quantity' and 'current_stock', copy from 'quantity' to 'current_stock'
UPDATE `inventory_items` 
