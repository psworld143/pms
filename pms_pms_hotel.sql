...
--
-- Host: localhost
-- Generation Time: Oct 07, 2025 at 12:35 AM
...
(3, 3, 3, 840.00, 45.00, 88.50, 0.00, 973.50, 'paid', NULL, '2025-10-02 03:37:17', '2025-10-02 03:37:17'),
...
(3, 'BILL20241202001', 3, '2024-12-02', '2024-12-02', 800.00, 86.40, 0.00, 886.40, 'pending', 'Business traveler', 4, '2025-08-27 10:02:44', '2025-08-27 10:02:44');
...
INSERT INTO `inventory_items` (`id`, `item_name`, `category_id`, `current_stock`, `minimum_stock`, `unit_price`, `description`, `last_updated`, `created_at`) VALUES
(1, 'Coffee Beans (Arabica)', 1, 50, 10, 450.00, 'Premium Arabica coffee beans for hotel restaurant | SKU: FB-COFFEE-001 | Unit: Kilogram | Supplier: Premium Coffee Supply Co.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(2, 'Tea Bags (Assorted)', 1, 25, 5, 120.00, 'Assorted tea bags for room service | SKU: FB-TEA-002 | Unit: Box | Supplier: Tea Masters Inc.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(3, 'Bottled Water (500ml)', 1, 200, 50, 15.00, 'Premium bottled water for guest rooms | SKU: FB-WATER-003 | Unit: Bottle | Supplier: Pure Water Solutions', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(4, 'Breakfast Cereal', 1, 30, 8, 85.00, 'Assorted breakfast cereals | SKU: FB-CEREAL-004 | Unit: Box | Supplier: Morning Delights Co.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(5, 'Fresh Milk (1L)', 1, 40, 10, 65.00, 'Fresh whole milk for breakfast service | SKU: FB-MILK-005 | Unit: Liter | Supplier: Dairy Fresh Farms', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(6, 'Bath Towels (White)', 2, 150, 30, 180.00, 'Premium white bath towels | SKU: AM-TOWEL-001 | Unit: Piece | Supplier: Luxury Linens Ltd.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(7, 'Hand Towels', 2, 200, 40, 95.00, 'Soft hand towels for guest bathrooms | SKU: AM-HANDTOWEL-002 | Unit: Piece | Supplier: Luxury Linens Ltd.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(8, 'Bathrobes (Cotton)', 2, 80, 20, 450.00, 'Premium cotton bathrobes | SKU: AM-BATHROBE-003 | Unit: Piece | Supplier: Luxury Linens Ltd.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(9, 'Shampoo (Hotel Size)', 2, 300, 60, 25.00, 'Premium hotel-size shampoo bottles | SKU: AM-SHAMPOO-004 | Unit: Bottle | Supplier: Spa Essentials Co.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(10, 'Body Lotion', 2, 250, 50, 22.00, 'Moisturizing body lotion | SKU: AM-LOTION-005 | Unit: Bottle | Supplier: Spa Essentials Co.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(11, 'Soap Bars (Luxury)', 2, 400, 80, 18.00, 'Luxury soap bars for guest bathrooms | SKU: AM-SOAP-006 | Unit: Piece | Supplier: Spa Essentials Co.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(12, 'All-Purpose Cleaner', 3, 50, 10, 85.00, 'Multi-surface cleaning solution | SKU: CS-CLEANER-001 | Unit: Bottle | Supplier: CleanPro Solutions', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(13, 'Glass Cleaner', 3, 30, 8, 75.00, 'Streak-free glass cleaning solution | SKU: CS-GLASS-002 | Unit: Bottle | Supplier: CleanPro Solutions', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(14, 'Disinfectant Spray', 3, 40, 10, 120.00, 'Hospital-grade disinfectant spray | SKU: CS-DISINFECT-003 | Unit: Bottle | Supplier: CleanPro Solutions', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(15, 'Microfiber Cloths', 3, 25, 5, 150.00, 'Reusable microfiber cleaning cloths | SKU: CS-CLOTHS-004 | Unit: Pack | Supplier: CleanPro Solutions', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(16, 'Vacuum Bags', 3, 20, 5, 200.00, 'Replacement vacuum cleaner bags | SKU: CS-VACBAG-005 | Unit: Pack | Supplier: CleanPro Solutions', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(17, 'A4 Paper (White)', 4, 15, 3, 180.00, 'Premium white A4 copy paper | SKU: OS-PAPER-001 | Unit: Ream | Supplier: Office Depot Pro', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(18, 'Ballpoint Pens (Blue)', 4, 10, 2, 120.00, 'Blue ballpoint pens for front desk | SKU: OS-PENS-002 | Unit: Box | Supplier: Office Depot Pro', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(19, 'Stapler with Staples', 4, 5, 1, 350.00, 'Heavy-duty stapler with staple refills | SKU: OS-STAPLER-003 | Unit: Piece | Supplier: Office Depot Pro', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(20, 'File Folders (Manila)', 4, 8, 2, 95.00, 'Manila file folders for guest records | SKU: OS-FOLDERS-004 | Unit: Box | Supplier: Office Depot Pro', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(21, 'Light Bulbs (LED)', 5, 100, 20, 45.00, 'Energy-efficient LED light bulbs | SKU: MT-LED-001 | Unit: Piece | Supplier: Electrical Supply Co.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(22, 'Air Filter (HVAC)', 5, 20, 5, 250.00, 'Replacement air filters for HVAC system | SKU: MT-FILTER-002 | Unit: Piece | Supplier: HVAC Solutions Inc.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(23, 'Paint (White)', 5, 8, 2, 450.00, 'Interior white paint for touch-ups | SKU: MT-PAINT-003 | Unit: Gallon | Supplier: Paint & Decor Co.', '2025-10-01 16:20:20', '2025-10-01 16:20:20'),
(24, 'Door Handles (Brass)', 5, 25, 5, 180.00, 'Brass door handles for guest rooms | SKU: MT-HANDLES-004 | Unit: Piece | Supplier: Hardware Solutions', '2025-10-01 16:20:20', '2025-10-01 16:20:20');
...
(1, '101', 'standard', 1, 2, 180.00, 'available', 'clean', 'WiFi, Flat-screen TV, Air Conditioning, Mini Fridge, Coffee Maker, Safe', '2025-08-27 10:02:44', '2025-10-02 03:37:17'),
...
(5, '202', 'deluxe', 2, 3, 280.00, 'available', 'clean', 'WiFi, 55\" Smart TV, Air Conditioning, Mini Bar, Coffee Maker, Safe, Balcony, City View', '2025-08-27 10:02:44', '2025-10-02 03:37:17'),
...
(1, 'Sarah Johnson', 'sarah.johnson', '$2y$10$YFkNeC.GlpWgMlNLWwAe/uM5O6LPRD5o.W94gaMN9JDZyOkwhSJqCA', 'sarah.johnson@grandhotel.com', 'manager', 1, '2025-08-27 10:02:44', '2025-10-07 00:33:11'),
